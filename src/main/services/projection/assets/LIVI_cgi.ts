...
const ACTION_LINES = [
  ...
  '}',
  '',
  'install_persistent_web() {',
  '  header_plain',
  '  cp /tmp/boa/cgi-bin/server.cgi /etc/boa/cgi-bin/server.cgi',
  '  cp /tmp/boa/www/index.html /etc/boa/www/index.html',
  '  sync',
  '  echo "done"',
  '}',
  '',
  'strip_vendor_web() {',
  '  header_plain',
  '  rm -rf /etc/boa/www/js /etc/boa/www/lang /etc/boa/www/static',
  '  rm -f /etc/boa/www/index.html.gz /etc/boa/www/favicon.png',
  '  rm -f /etc/boa/cgi-bin/upload.cgi',
  '  sync',
  '  echo "done"',
  '}',
  '',
...
const ROUTER_LINES = [
  ...
  '  b64)      b64_file "$path" ;;',
  '  install_persistent) install_persistent_web ;;',
  '  strip_vendor_web)   strip_vendor_web ;;',
  '  *)                  browse "/" ;;',
  'esac',
  ''
]
